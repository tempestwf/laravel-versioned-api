...
use TempestTools\Raven\Laravel\Notification\GeneralNotificationAbstract;
...
class EmailVerificationNotification extends GeneralNotificationAbstract
{
     ...
     * @return MailMessage
     */
    protected function addToMailMessage(MailMessage $mailMessage, /** @noinspection PhpSignatureMismatchDuringInheritanceInspection */ EntityContract $notifiable, array $settings):MailMessage {
